...
<main>
    ...
    if (isset($_GET['action'])) {
        if ($_GET['action'] == 'new' || $_GET['action'] = 'edit') {
            if (file_exists('src/admin/views/orders/add.php')) {
                include('src/admin/views/orders/add.php');
            } else {
                echo "Erro";
            }
        }
    } else {
        if (file_exists('src/admin/views/orders/list.php')) {
            include('src/admin/views/orders/list.php');
        } else {
            echo "Erro";
        }
    }
